...
1. 标签评估方法以及装置, ZL202511500351.3
1. 基于时空语义聚类与大语言模型的政务工单智能处理方法及系统, ZL202511333257.3
1. 基于语义提取与对齐的可量化指标体系构建方法及装置, ZL202511277341.8
1. 电话号码识别方法和装置、电子设备及存储介质, ZL202510117371.6
1. 基于坐标编码的量化指标体系生成及诊断方法以及系统,  ZL202310339635.3
1. 基于文本分析的科研项目产出评价验收方法及系统, ZL202211251387.9
1. 信用评价方法、装置及存储介质, CN202510682938.4	
1. 提升企业评价准确性的方法、装置、计算机设备及介质, CN202311395648.9
1. 多源数据融合的机器学习火灾预测与隐患识别方法及系统, CN202210977272.1

## Software
[DFVAD R Package](https://cran.rstudio.com/web/packages/dfvad/index.html): Author of this R computing package for identifying the main drivers of productivity and economic growth. The package supports decomposition of value-added growth into explanatory elements, production-frontier specification using a cost-constrained value-added function, and weighted aggregation of industry estimates. It has been officially approved by CRAN and is utilized by researchers interested in economic growth studies, with **18,000+** downloads. Details about the methodology and data can be found in [Diewert and Fox (2018)](https://academic.oup.com/edited-volume/41719/chapter-abstract/354003191?redirectedFrom=fulltext) and [Zeng, Parsons, Diewert and Fox (2018)](https://conference.unsw.edu.au/content/dam/pdfs/business/caer/research-reports/emg-workshop-2018/emg2018-6_SZeng_EMG-Slides.pdf). 
